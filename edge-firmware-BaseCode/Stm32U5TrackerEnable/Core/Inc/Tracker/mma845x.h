...
#define MMA845x_IIC_ADDRESS     0x38			// for write
//#define MMA8452Q_I2C_ADDR		0x1D			// unshifted address for jumper open, SA0 = 1
#define MMA8452Q_I2C_ADDR		0x3A
...
#define OUT_SIGN_MASK		0x80		// <sek> location of sign bit in MSB output register
#define	VALUE_SIGN_BIT		0xF000		// <sek> location of sign bit in assembled 11 bit + sign value
