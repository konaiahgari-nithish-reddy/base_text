...
extern char mon_topic[100];
extern char setting_topic[100];
...
char test_data[] = "{\n"
		...
		"  },\n"
		"  \"Azimuth\" : {\n"
		"    \"AZ_Offset\" : uint32_value,\n"
		"    \"AZ_SoftLimit_Reverse\" :uint32_value,\n"
		"    \"AZ_SoftLimit_Forward\" :\"uint32_value,\n"
		"    \"AZ_DeadBand\" : uint32_value,\n"
		"    \"AZ_NightStowThreshold\" : uint32_value,\n"
		"    \"AZ_NightStowPosition\" : uint32_value,\n"
		"    \"AZ_WindStowPosition\" : uint32_value\n"
		"  },\n"
		"  \"Elevation\" : {\n"
		"    \"EL_Offset\" : uint32_value,\n"
		"    \"EL_SoftLimit_Reverse\" :uint32_value,\n"
		"    \"EL_SoftLimit_Forward\" :\"uint32_value,\n"
		"    \"EL_DeadBand\" : uint32_value,\n"
		"    \"EL_NightStowThreshold\" : uint32_value,\n"
		"    \"EL_NightStowPosition\" : uint32_value,\n"
		"    \"EL_WindStowPosition\" : uint32_value\n"
		"  },\n"
		"  \"SingleAxis\" : {\n"
		"    \"BacktrackingEnabled\" : 1,\n"
		"    \"PanelShadowStartAngleDegrees\" : uint32_value,\n"
		"    \"SunShadowStartAngleDegrees\" : uint32_value,\n"
		"    \"SunShadowStartHeight\" : uint32_value,\n"
		"    \"Single_SoftLimit_Reverse\" : uint32_value,\n"
		"    \"Single_SoftLimit_Forward\" : uint32_value,\n"
		"    \"Single_start_date\" : 12,\n"
		"    \"Single_stop_days\" : 12\n"
		"  }\n"
		"}";
/*******************************************************
...
void esp_mesh_mqtt_task(void *arg)
{
    ...
    while (is_running) {
		...
		if (SIMULATION_NODE == 1) {
			mqtt_app_publish("/smarttrak/solartracker/server/monitor/SIM_NODE_N2", test_data);
		}
        ...
        ESP_LOGI("MQTT_TOPIC", "NodeID: %s", nodeID);
        ESP_LOGI("MQTT_TOPIC", "Monitor_Topic: %s", mon_topic);
        ESP_LOGI("MQTT_TOPIC", "Setting_Topic: %s", setting_topic);
        ESP_LOGI("MQTT_TOPIC", "Subscribe_Topic: %s", sub_topic);
...
//        xTaskCreate(check_button, "check button task", 3072, NULL, 5, NULL);	// Not Needed, instead need to implement UART reception & transmission task
                        ...
                        int32_t event_id, void *event_data)
{
    ...
    // Connect with switch to parent mode and connect to router
    break;
...
void app_main(void)
{
    ...
    cfg.allow_channel_switch = pdTRUE;
	...
	if (SIMULATION_NODE == 0) {
	    /* Start UART */
	    ESP_ERROR_CHECK(uart_init());
	    printf("\n\n\n############################\n");
	    ESP_LOGI("CONFIG_INFO", "Router SSID: %s", CONFIG_MESH_ROUTER_SSID);
	    ESP_LOGI("CONFIG_INFO", "Router Password: %s", CONFIG_MESH_ROUTER_PASSWD);
	    ESP_LOGI("CONFIG_INFO", "Router Channel: %d", CONFIG_MESH_CHANNEL);
	    printf("############################\n\n\n");
	...
	// Configure Mesh to force setup root device
#if MESH_ROOT_NODE == 1
