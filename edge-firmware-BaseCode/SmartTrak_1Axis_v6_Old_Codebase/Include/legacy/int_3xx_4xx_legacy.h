 ...
 ***************************************************************************************
 */
#if ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450))
...
#define mCNDClearIntFlag()                   (IFS1CLR = _IFS1_CNDIF_MASK)
#define mCNDGetIntFlag()                     (IFS1bits.CNDIF)
#define mCNDGetIntEnable()                   (IEC1bits.CNDIE)
#define mCNDIntEnable(enable)                (IEC1CLR = _IEC1_CNDIE_MASK, IEC1SET = ((enable) << _IEC1_CNDIE_POSITION))

#define mCNEClearIntFlag()                   (IFS1CLR = _IFS1_CNEIF_MASK)
#define mCNEGetIntFlag()                     (IFS1bits.CNEIF)
#define mCNEGetIntEnable()                   (IEC1bits.CNEIE)
#define mCNEIntEnable(enable)                (IEC1CLR = _IEC1_CNEIE_MASK, IEC1SET = ((enable) << _IEC1_CNEIE_POSITION))

#define mCNFClearIntFlag()                   (IFS1CLR = _IFS1_CNFIF_MASK)
#define mCNFGetIntFlag()                     (IFS1bits.CNFIF)
#define mCNFGetIntEnable()                   (IEC1bits.CNFIE)
#define mCNFIntEnable(enable)                (IEC1CLR = _IEC1_CNFIE_MASK, IEC1SET = ((enable) << _IEC1_CNFIE_POSITION))

#define mCNGClearIntFlag()                   (IFS1CLR = _IFS1_CNGIF_MASK)
#define mCNGGetIntFlag()                     (IFS1bits.CNGIF)
#define mCNGGetIntEnable()                   (IEC1bits.CNGIE)
#define mCNGIntEnable(enable)                (IEC1CLR = _IEC1_CNGIE_MASK, IEC1SET = ((enable) << _IEC1_CNGIE_POSITION))
...
#define mSPI2SetIntPriority(priority)        (IPC8CLR = _IPC8_SPI2IP_MASK, IPC8SET = ((priority) << _IPC8_SPI2IP_POSITION))
#define mSPI2GetIntPriority()                (IPC8bits.SPI2IP)
#define mSPI2SetIntSubPriority(subPriority)  (IPC8CLR = _IPC8_SPI2IS_MASK, IPC8SET = ((subPriority) << _IPC8_SPI2IS_POSITION))
#define mSPI2GetIntSubPriority()             (IPC8bits.SPI2IS)
#endif
...
#define mU1SetIntPriority(priority)         (IPC7CLR = _IPC7_U1IP_MASK, IPC7SET = ((priority) << _IPC7_U1IP_POSITION))
#define mU1GetIntPriority()                 (IPC7bits.U1IP)
#define mU1SetIntSubPriority(subPriority)   (IPC7CLR = _IPC7_U1IS_MASK, IPC7SET = ((subPriority) << _IPC7_U1IS_POSITION))
#define mU1GetIntSubPriority()              (IPC7bits.U1IS)
#endif
#ifdef _UART2
/*********************************************************************
...
#define mU2SetIntPriority(priority)        (IPC9CLR = _IPC9_U2IP_MASK, IPC9SET = ((priority) << _IPC9_U2IP_POSITION))
#define mU2GetIntPriority()                (IPC9bits.U2IP)
#define mU2SetIntSubPriority(subPriority)  (IPC9CLR = _IPC9_U2IS_MASK, IPC9SET = ((subPriority) << _IPC9_U2IS_POSITION))
#define mU2GetIntSubPriority()             (IPC9bits.U2IS)
#endif
...
#if ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450))
#ifdef _I2C1
#define mI2C1BClearIntFlag()                (IFS1CLR = _IFS1_I2C1BIF_MASK)
...
#define mI2C2GetIntPriority()               (IPC9bits.I2C2IS)
...
#if ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450))
#ifdef _DMAC0
#define mDMA0ClearIntFlag()                     (IFS2CLR = _IFS2_DMA0IF_MASK)
#define mDMA0GetIntFlag()                       (IFS2bits.DMA0IF)
#define mDMA0GetIntEnable()                     (IEC2bits.DMA0IE)
#define mDMA0IntEnable(enable)                  (IEC2CLR = _IEC2_DMA0IE_MASK, IEC2SET = ((enable) << _IEC2_DMA0IE_POSITION))
...
#ifdef _DMAC1
#define mDMA1ClearIntFlag()                     (IFS2CLR = _IFS2_DMA1IF_MASK)
#define mDMA1GetIntFlag()                       (IFS2bits.DMA1IF)
#define mDMA1GetIntEnable()                     (IEC2bits.DMA1IE)
#define mDMA1IntEnable(enable)                  (IEC2CLR = _IEC2_DMA1IE_MASK, IEC2SET = ((enable) << _IEC2_DMA1IE_POSITION))
...
#ifdef _DMAC2
#define mDMA2ClearIntFlag()                     (IFS2CLR = _IFS2_DMA2IF_MASK)
#define mDMA2GetIntFlag()                       (IFS2bits.DMA2IF)
#define mDMA2GetIntEnable()                     (IEC2bits.DMA2IE)
#define mDMA2IntEnable(enable)                  (IEC2CLR = _IEC2_DMA2IE_MASK, IEC2SET = ((enable) << _IEC2_DMA2IE_POSITION))
#define mDMA2SetIntPriority(priority)           (IPC11CLR = _IPC11_DMA2IP_MASK, IPC11SET = ((priority) << _IPC11_DMA2IP_POSITION))
#define mDMA2GetIntPriority()                   (IPC11bits.DMA2IP)
#define mDMA2SetIntSubPriority(subPriority)     (IPC11CLR = _IPC11_DMA2IS_MASK, IPC11SET = ((subPriority) << _IPC11_DMA2IS_POSITION))
#define mDMA2GetIntSubPriority()                (IPC11bits.DMA2IS)
#endif

#ifdef _DMAC3
#define mDMA3ClearIntFlag()                     (IFS2CLR = _IFS2_DMA3IF_MASK)
#define mDMA3GetIntFlag()                       (IFS2bits.DMA3IF)
#define mDMA3GetIntEnable()                     (IEC2bits.DMA3IE)
#define mDMA3IntEnable(enable)                  (IEC2CLR = _IEC2_DMA3IE_MASK, IEC2SET = ((enable) << _IEC2_DMA3IE_POSITION))
#define mDMA3SetIntPriority(priority)           (IPC11CLR = _IPC11_DMA3IP_MASK, IPC11SET = ((priority) << _IPC11_DMA3IP_POSITION))
#define mDMA3GetIntPriority()                   (IPC11bits.DMA3IP)
#define mDMA3SetIntSubPriority(subPriority)     (IPC11CLR = _IPC11_DMA3IS_MASK, IPC11SET = ((subPriority) << _IPC11_DMA3IS_POSITION))
#define mDMA3GetIntSubPriority()                (IPC11bits.DMA3IS)
#endif
